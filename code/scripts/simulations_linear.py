...
#
# Simulations using F(k,s) = ak + bs + cks (i.e. k and s not squared)
...
rmm.gen_plots(all_results_lognormal_0_50,labels=["c=0.01","c=1.5","c=3"],output_path = os.path.join(os.getcwd(),'data', 'output','ln_plot_rho0_5_linear.png'))
...
rmm.gen_plots(all_results_lognormal_0_10,labels=["c=0.01","c=1.5","c=3"],output_path = os.path.join(os.getcwd(),'data', 'output','ln_plot_rho0_10_linear.png'))
...
size = 1000
dist = "lognormal"
revenue_params = {'a':3,'b':1,'c':1.5,'n':1,'m':1} # where F(k,s) = a*k**n + b*s**m + c*k*s
