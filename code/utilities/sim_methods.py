...
def sim_params(config):
    ...
    print("Skills are distributed as",config['distribution']['distribution_type'],"with k role mean",config['distribution']['parameters']['mean_k'],
          "with s role mean",config['distribution']['parameters']['mean_s'],
